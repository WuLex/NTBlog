...
namespace NTBlogWeb.Helper
{
    public class PinYinHelper
    {
        ...
        public static string GetFirstLetter(string hz)
        {
            ...
            {
                var array = Encoding.Default.GetBytes(hz[i].ToString());
                ...
                {
                    returnPy += lsSecondEng.Substring(lsSecondCh.IndexOf(hz[i].ToString(), 0, StringComparison.Ordinal),
                        1);
                }
            }
